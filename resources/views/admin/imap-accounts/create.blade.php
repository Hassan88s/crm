...
@section('title', 'Add IMAP Account')
@section('page-title', 'Add IMAP Account')
...
<div class="form-card">
    <h2 style="font-size:1.15rem;font-weight:700;color:#0f172a;margin-bottom:1.5rem;">Add New IMAP Account</h2>

    <form action="{{ route('admin.imap-accounts.store') }}" method="POST">
        @csrf
        ...
        <div class="form-grid">
            <div class="form-group full">
                ...
                <input type="text" name="name" value="{{ old('name') }}"
                       ...
                       placeholder="e.g. Hostinger Inbox 1">
            ...
            <div class="form-group">
                ...
                <input type="number" name="port" value="{{ old('port', 993) }}"
            ...
            <div class="form-group">
                ...
                <input type="color" name="color" value="{{ old('color', '#2563eb') }}" class="form-input" style="height:42px; padding:4px;">
            </div>
