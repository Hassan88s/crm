...
@section('page-title', 'Edit SMTP Account')
...
<div class="form-card">
    <h2 style="font-size:1.15rem;font-weight:700;color:#0f172a;margin-bottom:1.5rem;">Edit SMTP Account</h2>

    <form action="{{ route('admin.smtp-accounts.update', $account) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input type="email" name="from_address" value="{{ old('from_address', $account->from_address) }}"
            ...
            <div class="form-group">
                ...
                <input type="text" name="from_name" value="{{ old('from_name', $account->from_name) }}"
